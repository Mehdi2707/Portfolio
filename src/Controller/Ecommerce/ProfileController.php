...
#[Route('/ecommerce/profil', name: 'profile_')]
class ProfileController extends AbstractController
{
    #[Route('/', name: 'index')]
    public function index(): Response
    {
        return $this->render('Ecommerce/profile/index.html.twig', [
    ...
    public function edit(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('Ecommerce/profile/edit.html.twig', [
    ...
    public function editPassword(Request $request, EntityManagerInterface $entityManager, UserPasswordHasherInterface $passwordHasher): Response
    {
        ...
        return $this->render('Ecommerce/profile/editpassword.html.twig', [
        ]);
    }
    ...
    public function orders(OrdersRepository $ordersRepository, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('Ecommerce/profile/orders.html.twig', [
            'orders' => $orders,
