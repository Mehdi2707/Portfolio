...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordHasherInterface $userPasswordHasher, UserAuthenticatorInterface $userAuthenticator, UsersAuthenticator $authenticator, EntityManagerInterface $entityManager, SendMailService $mailService, JWTService $JWTService): Response
    {
        ...
        return $this->render('Ecommerce/registration/register.html.twig', [
            'registrationForm' => $form->createView(),
        ]);
    }

    #[Route('/verif/{token}', name: 'verify_user')]
    public function verifyUser($token, JWTService $JWTService, UserRepository $usersRepository, EntityManagerInterface $entityManager): Response
    {
    ...
    public function resendVerif(JWTService $JWTService, SendMailService $mailService, UserRepository $usersRepository): Response
    {
        $user = $this->getUser();
